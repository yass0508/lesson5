...
INSERT INTO customer (customer_id, cust_name, city, grade, Salesman_id)VALUES
    ...
    ('3005', 'Nick Rimando', 'california', 200,'5002'),
    ('3008', 'Nick Rimando', 'london', 300,'5002'),
    ('3004', 'Nick Rimando', 'paris', 300,'5006'),
    ('3009', 'Nick Rimando', 'berlin', 100,'5003'),
    ('3003', 'Nick Rimando', 'Moscow', 200,'5007'),
    ('3001', 'Nick Rimando', 'London', NULL,'5005');
...
INSERT INTO Orders (ord_no, purch_amt, ord_date, customer_id, Salesman_id) VALUES
    ...
    ('70002', 62.26, '2012-10-05', 3002,'5003'),
    ('70004', 110.5, '2012-08-17', 3009,'5007'),
    ('70007', 498.5, '2012-09-10', 3005,'5005'),
...
Orders.purch_amt* Saleslan.Comission AS "Comission"
FROM Orders
JOIN Salesman ON Orders.Salesman_id=Salesman.Salesman_id
JOIN Customer ON Orders.customer_id=Customer.customer_id
